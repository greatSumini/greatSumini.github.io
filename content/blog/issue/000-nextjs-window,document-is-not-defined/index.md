...
If the simple fact of importing the library is enough to trigger the error, you'll need to replace it with something like if

```javascript
(typeof window !== 'undefined') { require('the-lib'); }.
```

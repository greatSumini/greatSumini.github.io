...
어땠나요? 실질적인 내용은 여섯줄 밖에 안 되지만, 그닥 술술 읽히는 코드는 아니라고 생각합니다. 이유는 다음과 같습니다.

<br>

먼저 body 첫줄의 `let result = 0;` line은 아래 내용을 읽기 전까진 아무런 의미를 갖지 않습니다.

바로 다음 줄의 for문 선언부도 마찬가지입니다. 코드내에서 for문이 어떤 영향을 끼치고 있는지 파악하기 위해 모든 line을 읽어야만 합니다.

이 함수는 워낙 짧고 간단하기 때문에 이해가 어렵지 않겠지만, 복잡한 모듈속에서 이런 line들은 읽는 이를 피곤하게 만들 수 있습니다.
...
filter/reduce 함수를 활용한 것보다, 코드를 위에서 아래로 쭉 읽을 수 있다는 점에 집중해주세요.
